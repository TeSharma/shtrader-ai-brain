...
Start with Step 1: inspect the official ADTC template and profiler requirements, then scaffold the repository around those requirements without implementing unnecessary features yet.

One important point: Shtrader LA should be the core intelligence engine, while the main Shtrader platform remains the product and execution environment. This way, if the hackathon project performs well, you're not starting over afterward—you'll already have the foundation for the AI layer of the larger platform.

This project was built with [Lovable](https://lovable.dev).

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/91387750-0e21-472f-bdfc-21baf782cb24).
